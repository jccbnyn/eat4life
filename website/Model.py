...
class CharityEvent(Base):
    ...
    def __repr__(self):
            return ('<CharityEvent(%d, %s, %s, %s, %d)>' % (self.charityEventID,
...
class CharityEventInvitee(Base):
    ...
    def __repr__(self):
        return ('<CharityEventInvitee(%d, %d, %d, %s, %s)>' %
                (self.charityEventInviteeID, self.charityEventID, 
                self.userID, self.isHost, self.isAttending))
